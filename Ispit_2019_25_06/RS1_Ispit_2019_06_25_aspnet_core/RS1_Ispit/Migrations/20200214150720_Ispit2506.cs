...
{
    public partial class Ispit2506 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_IspitDetalji", x => x.Id);
                    table.ForeignKey(
                        name: "FK_IspitDetalji_Ispit_IspitID",
                        column: x => x.IspitID,
                        principalTable: "Ispit",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_IspitDetalji_Student_StudentID",
                        column: x => x.StudentID,
                        principalTable: "Student",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_IspitDetalji_IspitID",
                table: "IspitDetalji",
                column: "IspitID");

            migrationBuilder.CreateIndex(
                name: "IX_IspitDetalji_StudentID",
                table: "IspitDetalji",
                column: "StudentID");
