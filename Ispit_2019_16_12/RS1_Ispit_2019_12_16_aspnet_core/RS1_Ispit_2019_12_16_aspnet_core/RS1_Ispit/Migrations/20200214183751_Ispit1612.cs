...
{
    public partial class Ispit1612 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PopravniIspit_Nastavnik_Nastavnik1ID",
                        column: x => x.Nastavnik1ID,
                        principalTable: "Nastavnik",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.NoAction);
                    table.ForeignKey(
                        name: "FK_PopravniIspit_Nastavnik_Nastavnik2ID",
                        column: x => x.Nastavnik2ID,
                        principalTable: "Nastavnik",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.NoAction);
                    table.ForeignKey(
                        name: "FK_PopravniIspit_Nastavnik_Nastavnik3ID",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Pristup = table.Column<bool>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PopravniIspit_Nastavnik1ID",
                table: "PopravniIspit",
                column: "Nastavnik1ID");

            migrationBuilder.CreateIndex(
                name: "IX_PopravniIspit_Nastavnik2ID",
                table: "PopravniIspit",
                column: "Nastavnik2ID");

            migrationBuilder.CreateIndex(
                name: "IX_PopravniIspit_Nastavnik3ID",
                table: "PopravniIspit",
                column: "Nastavnik3ID");
